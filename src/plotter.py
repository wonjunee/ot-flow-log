...
def plot4_gf(net, x, y, nt_val, n_tau, net_list, sPath, sTitle="", doPaths=False):
    """
    ...
    fx = integrate_gf(x[:, 0:d], net, [0.0, 1.0], nt_val, n_tau, net_list, stepper="rk4", alph=net.alph)
